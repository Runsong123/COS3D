...
def get_language_feature(feature_map, seg_map, feature_level):
    ...
    image_height,image_width = seg_map.shape[1], seg_map.shape[2]
...
def readColmapSceneInfo(path, foundation_model, images, eval, llffhold=8): # 读取scene信息
    ...
    if foundation_model =='sam2_clip': # switch the feature type
        semantic_feature_dir='language_features_SAM2_local_large'
        semantic_feature_folder = os.path.join(path, semantic_feature_dir)
        print("using foundation model:", foundation_model, "features from:", semantic_feature_folder)
    if foundation_model =='semantic_sam': # switch the feature type
        semantic_feature_dir='language_features_Semantic_SAM_local'
        semantic_feature_folder = os.path.join(path, semantic_feature_dir)
        print("using foundation model:", foundation_model, "features from:", semantic_feature_folder)
    if foundation_model =='sam_siglip': # switch the feature type
        semantic_feature_dir='language_features_SigLip'
        semantic_feature_folder = os.path.join(path, semantic_feature_dir)
        print("using foundation model:", foundation_model, "features from:", semantic_feature_folder)
